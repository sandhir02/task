...
const Signup = () => {
  return (
    ...
    //   <div className="max-w-[1720px]  mx-auto  px-4 xl:px-[100px] w-full min-h-[calc(100vh-80px)] flex grow items-center">
    //     <div className="flex flex-col  xl:flex-row items-center  rounded-[10px justify-between h-[875px]  ">
    //       <div className="w-full sm:w-[60%]  xl:w-1/2 h-full">
    //         <div className="bg-[#151515]/20 h-full">
    //           <img
    //             className="w-full sm:max-w-full max-xl:max-w-[400px]  h-full"
    //             src="./assets/images/png/signup-img.png"
    //             alt="image"
    //           />
    //         </div>
    //       </div>
    //       <div className="w-full sm:w-[60%] xl:w-1/2 bg-[#151515] h-full min-h-[630px] flex justify-center items-center py-20 xl:py-0 px-4  xl:px-0">
    //         <div>
    //           <span>
    //             <SpeedoIcon />
    //           </span>
    ...
    //             Create an account
    //           </h2>
    //           <p className="text-[16px] xl:text-[18px] text-[#757575] font-medium font-helvetica leading-[100%] pt-[1px] max-w-[555px]">
    ...
    //               className="bg-[#333333] rounded-[10px] text-white font-helvetica font-normal text-base xl:text-[18px] p-4 xl:p-6 outline-none"
    //             />
    //             <input
    //               placeholder="Phone Number"
    //               className="bg-[#333333] rounded-[10px] text-white font-helvetica font-normal text-base xl:text-[18px] p-4 xl:p-6 mt-[22px] "
    //             />
    //           </form>
    ...
    //             <input
    //               className="w-[22px] h-[22px] border-white border-[1.5px] bg-transparent"
    //               type="checkbox"
    //               name=""
    //               id="terms"
    //             />
    ...
    //             <label
    //               htmlFor="terms"
    //               className="font-helvetica font-normal text-[12px] xl:text-[14px] text-white max-w-[494px]">
    ...
    //           {/* Verify Button */}
    //           <button
    //             className=" font-helvetica font-bold text-base xl:text-[20px] bg-[#FD0100] hover:bg-[#FD0100]/70 mt-6 w-full text-white
    //            py-4 xl:py-[22px] rounded-[10px]">
    //             Verify Account
    //           </button>
    ...
    <div className="bg-black min-h-screen w-full flex items-center justify-center py-10">
      <div className="max-w-[1720px] w-full flex flex-col max-xl:items-center  xl:flex-row rounded-[10px] overflow-hidden bg-black">
        {/* Left Image Side */}
        <div className="w-full md:w-[70%] xl:w-1/2 relative">
        ...
        {/* Right Form Side */}
        <div className="w-full md:w-[70%] xl:w-1/2 bg-[#151515] flex items-center justify-center px-4 xl:px-0 py-10 xl:py-18">
